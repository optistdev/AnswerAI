...
const EditVariables = ({ onClick, className }: EditVariablesProps) => {
  ...
  return (
    <div className={`bg-black/50 z-50 backdrop-blur-xs fixed top-0 left-0 w-screen flex justify-end ${className}`}>
      <div className="w-172 bg-[#0E0D0D] h-screen border-l-2 border-[#525252] relative px-7 py-3 overflow-y-auto">
        ...
        <div className="bg-[#161618] border border-[#525252] rounded-sm">
          <div className="h-101 border-b border-[#525252] py-8 px-6 overflow-y-auto">
            {variables.map((group) => (
          ...
          <div
            ...
            `}
          >
            <div className="bg-[#222324] py-8 px-8 rounded-md">
